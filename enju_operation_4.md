...
#### 0. TSVファイルを用意します。TSVファイルの作り方の詳細については、「[4-2-8 TSVファイルの作り方](#section4-2-8) 」を参照してください。
...
### 4-2-8 TSVファイルの作り方（図書（書誌）） {#section4-2-8}
...
所蔵情報と書誌情報を同時に登録することも可能です。 その場合は、所蔵情報と[4-2-8 TSVファイルの作り方（図書（書誌））](#section4-2-8)のフィールドを書いたTSVを用意します。
</div>
