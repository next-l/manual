...
#### 2. メッセージを送りたいユーザの[利用者番号]をクリックします。
...
#### 1. メールアイコンのとなりに、未読のメッセージ数が表示されます。

![未読メッセージ数表示](assets/images/image_initial_009_0.png)

#### 2. ［アカウント］の左にあるメールアイコンをクリックします。
