...
* 右メニューの[戻る]をクリックしても前の画面には戻らないバグがあります。（詳細 [#996](https://github.com/next-l/enju_leaf/issues/995)）
...
* 右メニューの[戻る]をクリックしても前の画面には戻らないバグがあります。（詳細 [#997](https://github.com/next-l/enju_leaf/issues/997)）
