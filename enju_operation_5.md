...
* 右メニューの図書館、言語、出版日、予約可能については、[利用マニュアル 「1-4 検索結果を絞り込む」](enju_user_1.html#section1-4)を参照ください。
...
<!-- #1057 * （推奨）NDLサーチを検索して登録する方法 （詳細：[5-1-1](#section5-1-1)節）-->

* (バグ [#1057](https://github.com/next-l/enju_leaf/issues/1057) があるため使用しないでください) NDLサーチを検索して登録する方法 （詳細：[5-1-1](#section5-1-1)節）
...
注意!　Enju 1.1.0, 1.1.1, 1.1.2 では、致命的なバグがあるため、この機能は使用しないでください（詳細： [issue #1057](https://github.com/next-l/enju_leaf/issues/1057)）
...
<!-- #1057 国立国会図書館に納本されていない雑誌など、[5-1-1](#section5-1-1)節の方法が使えない場合には、-->
